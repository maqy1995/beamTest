...
import mobileGame.GameActionInfo.KeyField;
...
public class Exercise1 {
  ...
  public static void main(String[] args) throws Exception {
    ...
    new Input.BoundedGenerator();
    PCollection<GameActionInfo> gameIn=pipeline.apply(new Input.BoundedGenerator());
    ...
    gameIn
        ...
        .apply(new Output.WriteUserScoreSums("/home/maqy/桌面/output/output1"));

    // Run the batch pipeline.
    pipeline.run();


    ExerciseOptions options2 = PipelineOptionsFactory.fromArgs(args).withValidation().as(ExerciseOptions.class);
    options2.setStreaming(true);
    Pipeline pipeline2 = Pipeline.create(options2);
    PCollection<GameActionInfo> gameIn2=pipeline2.apply(new Input.BoundedGenerator());
    // Generate a bounded set of data.
    ...
    gameIn2
            ...
            // Write the user and score to the "user_score" BigQuery table.
            .apply(new Output.WriteUserScoreSums("/home/maqy/桌面/output/mmmmmmmmmmmm"));
