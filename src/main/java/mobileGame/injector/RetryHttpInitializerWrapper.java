...
public class RetryHttpInitializerWrapper implements HttpRequestInitializer {
  ...
  /**
   * Intercepts the request for filling in the "Authorization" header field, as
   * well as recovering from certain unsuccessful error codes wherein the
   * Credential must refresh its token for a retry.
   */
   ...
   *          Credential which will be wrapped and used for providing auth
   *          header.
   */
