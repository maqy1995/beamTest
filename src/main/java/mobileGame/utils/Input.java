...
import mobileGame.injector.InjectorBoundedSource;
import mobileGame.injector.InjectorUnboundedSource;
...
public class Input {
  ...
  public static class BoundedGenerator extends PTransform<PBegin, PCollection<GameActionInfo>> {
    ...
    public PCollection<GameActionInfo> expand(PBegin input) {
      return input.apply(Read.from(new InjectorBoundedSource(15, 180, 200)));
    }
  }
